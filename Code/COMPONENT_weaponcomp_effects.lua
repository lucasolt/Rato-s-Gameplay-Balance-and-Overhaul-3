function weapon_components_rat()
    ...
    PlaceObj('WeaponComponentEffect', {
        ...
        Description = T(954592406374,
                        "Reduce AP necessary to swap to this weapon"),
        group = "Other",
        id = "FreeWeaponSwap"
    })
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(149904848408,
                        "Greatly increased <em>recoil penalty</em>"),
        group = "FX Placeholders",
        id = "no_stock"
    })
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(472185658894,
                        "Significant increase in <em>recoil penalty</em>"),
        group = "FX Placeholders",
        id = "m14_recoil"
    })
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(375224625649,
                        "Harder to hit closer targets"),
        Parameters = {
            PlaceObj(
                'PresetParamNumber', {
                    'Name',
    ...
    PlaceObj('WeaponComponentEffect', {
        ...
        Description = T(975264803458,
                        "Decreases Accuracy bonus from Aiming"),
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(780091744194,
                        "Has bonus damage against <em>Flanked</em> targets"),
        group = "FX Placeholders",
        id = "flanker"
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(742720959709,
                        "Recovers half <em>free move AP</em> after shooting"),
        group = "FX Placeholders",
        id = "ShootMoving"
    })

    PlaceObj('WeaponComponentEffect', {
        Description = T(282151114911,
                        "<em>Accuracy</em> penalty when not prone"),
        group = "FX Placeholders",
        id = "bipod_penalty"
    })

    PlaceObj('WeaponComponentEffect', {
        Description = T(153429703325,
                        "Minor <em>Accuracy</em> penalty"),
        Parameters = {
            PlaceObj(
                'PresetParamPercent', {
                    'Name', "bonus_cth",
    ...
    PlaceObj('WeaponComponentEffect', {
        ...
        Description = T(486765316396,
                        "Changes caliber to 7.62x54mmR"),
        group = "Caliber",
    ...
    PlaceObj('WeaponComponentEffect', {
        CaliberChange = "556",
        Description = T(864532654693,
                        "Changes caliber to 5.56x45mm"),
        group = "Caliber",
    ...
    PlaceObj('WeaponComponentEffect', {
        CaliberChange = "762WP",
        Description = T(953726500783,
                        "Changes caliber to 7.62x39mm WP"),
        group = "Caliber",
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(939111789534,
                        "Decreases base critical chance"),
        ModificationType = "Subtract",
        Parameters = {
            PlaceObj(
                'PresetParamNumber', {
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(398049834770,
                        "Reduced <em>recoil penalty</em>"),
        group = "FX Placeholders",
        id = "compensator_effect"
    })

    PlaceObj('WeaponComponentEffect', {
        Description = T(954822518050,
                        "Slightly reduced <em>recoil penalty</em>"),
        group = "FX Placeholders",
        id = "recoil_booster_effect"
    })

    PlaceObj('WeaponComponentEffect', {
        Description = T(598891097935,
                        "Reduced <em>recoil penalty</em>"),
        group = "FX Placeholders",
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(400216040089,
                        "Decreases <em>Shooting Angle</em>"),
        ModificationType = "Multiply",
        Parameters = {
            PlaceObj(
                'PresetParamNumber', {
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(601041780492,
                        "Increases <em>Shooting Angle</em>"),
        ModificationType = "Multiply",
        Parameters = {
            PlaceObj(
                'PresetParamNumber', {
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(558731788097,
                        "Increased <em>recoil penalty</em>"),
        group = "FX Placeholders",
        id = "stocklight_effect_recoil"
    })

    PlaceObj('WeaponComponentEffect', {
        Description = T(203713773863,
                        "Reduced <em>recoil penalty</em>"),
        group = "FX Placeholders",
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(872923011488,
                        "Grants bonus Critical Chance to attacks with 2+ aim levels"),
        group = "FX Placeholders",
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(905983597373,
                        "Grants a small bonus Critical Chance per aim level"),
        group = "FX Placeholders",
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(337691694250,
                        "Increase AP cost when attacking"),
        Parameters = {
            PlaceObj(
                'PresetParamNumber', {
                    'Name',
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(905040013361,
                        "Reduced <em>Snapshot</em> accuracy <em>penalty</em>"),
        group = "FX Placeholders",
        id = "hipfire_no_stock"
    })
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(498214252783,
                        "Increased cost to rotate weapon when prone"),
        group = "FX Placeholders",
        id = "rotate_ap_bipod"
    })
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(183183480025,
                        "Increased <em>Snapshot</em> accuracy <em>penalty</em>"),
        group = "FX Placeholders",
        id = "drum_mag_hipfire"
    })

    PlaceObj('WeaponComponentEffect', {
        Description = T(266874774409,
                        "Decreases Aim accuracy when prone"),
        group = "FX Placeholders",
        id = "grip_prone_penalty"
    })

    PlaceObj('WeaponComponentEffect', {
        Description = T(982346640578,
                        "Slightly reduced <em>recoil penalty</em>"),
        group = "FX Placeholders",
        id = "tac_grip_recoil"
    })
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(845256852079,
                        "Reduced <em>Hipfire and Snapshot penalty</em>"),
        group = "FX Placeholders",
        id = "tac_grip_hipfire"
    })

    PlaceObj('WeaponComponentEffect', {
        Description = T(952508575329,
                        "Slightly increased Point-Blank range accuracy bonus"),
        group = "FX Placeholders",
        id = "tac_grip_PB"
    })
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(244679400091,
                        "Reduces <em>Snapshot Penalty</em> by <snap_reduc>%"),
        Parameters = {
            PlaceObj(
                'PresetParamNumber', {
                    'Name',
    ...
    PlaceObj('WeaponComponentEffect', {
        ...
        Description = T(355372332150,
                        "Increases Accuracy for aimed attacks by <bonus_cth>%"),
        Parameters = {
            PlaceObj(
                'PresetParamNumber', {
                    'Name', "bonus_cth",
    ...
    PlaceObj('WeaponComponentEffect', {
        Comment = "In aiming cth",
        Description = T(210060101900,
                        "Increases Accuracy for aimed attacks by <bonus_cth_v>%"),
        Parameters = {
            PlaceObj(
                'PresetParamNumber', {
                    'Name',
    ...
    PlaceObj('WeaponComponentEffect', {
        Comment = "In aiming cth",
        Description = T(978415485249,
                        "Grants bonus Critical Chance for aimed attacks at the head"),
        Parameters = {
            PlaceObj(
                'PresetParamNumber', {
                    'Name',
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(195877439875,
                        "Increases <em>Recoil</em> penalty"),
        group = "FX Placeholders",
        id = "FullChokeRecoil"
    })

    PlaceObj('WeaponComponentEffect', {
        Description = T(674215963791,
                        "Changes pellet spread pattern, reducing vertical spread"),
        ModificationType = "Subtract",
        Parameters = {
            PlaceObj(
                'PresetParamNumber', {
                    'Name',
                    "VerticalSpreadReduction",
                    'Tag',
                    "<VerticalSpreadReduction>"
                })
        },
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(912316475877,
                        "Increases Point-Blank range accuracy bonus"),
        ModificationType = "Add",
        Parameters = {
            PlaceObj(
                'PresetParamNumber', {
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(156932878971,
                        "Decreases Point-Blank range accuracy bonus"),
        ModificationType = "Subtract",
        Parameters = {
            PlaceObj(
                'PresetParamNumber', {
    ...
    PlaceObj('WeaponComponentEffect', {
        Comment = "In aiming cth",
        Description = T(320356428271,
                        "Grants bonus Critical Chance for aimed attacks at the torso"),
        Parameters = {
            PlaceObj(
                'PresetParamNumber', {
                    'Name',
    ...
    PlaceObj('WeaponComponentEffect', {
        Description = T(645613895578,
                        "Increases weapon condition degradation"),
        ModificationType = "Add",
        Parameters = {
            PlaceObj(
                'PresetParamNumber', {
    ...
    --                    "Increases Accuracy granted by the first aim level"),
    --    group = "Aiming",
    --    Parameters = {
    --        PlaceObj(
    --            'PresetParamNumber', {
    ...
    if WeaponComponentEffects then
        if WeaponComponentEffects.ExtraOverwatchShots then
            WeaponComponentEffects.ExtraOverwatchShots
                .unit_reactions = {
                PlaceObj('UnitReaction',
                         {
                    ...
                    Handler = function(
                        ...
                        local wep =
                            target:GetActiveWeapons()
                        if not wep then
                            return value
                        end
                        local bonus =
                            WeaponComponentEffects.ExtraOverwatchShots:ResolveValue(
                                "extra_attacks") or
                                1
                        if wep == self then
                            return
        ...
        if WeaponComponentEffects.FirstAimBonusModifier then
            ...
            firstaim.Description = T(
                                       175082911037,
                                       "Increases <em>Aim Accuracy</em> granted by the first level by +<first_aim_bonus_acc>")
            firstaim.RequiredParams = {
                "first_aim_bonus_acc"
            }
            firstaim.Parameters = {
                PlaceObj(
...
local t_table = {
    ...
    [175082911037] = 'Increases <em>Aim Accuracy</em> granted by the first level by +<first_aim_bonus_acc>',
