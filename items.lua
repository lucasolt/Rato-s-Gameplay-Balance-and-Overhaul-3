return {
	...
	PlaceObj('ModItemCode', {
		'name', "CTH_lowprofile_croc",
		'CodeFileName', "Code/CTH_lowprofile_croc.lua",
	}),
	PlaceObj('ModItemCode', {
		'name', "UTIL",
	...
	PlaceObj('ModItemFolder', {
		...
		PlaceObj('ModItemCode', {
			'name', "PATCH_aCTH_ScopesAndComponents",
			'CodeFileName', "Code/PATCH_aCTH_ScopesAndComponents.lua",
		}),
		PlaceObj('ModItemCode', {
		...
		PlaceObj('ModItemCode', {
			'name', "PATCH_GBO_ApplyComponentAncestorEffect",
		...
		PlaceObj('ModItemCode', {
			'name', "_PATCH_GBO_weapons",
			'CodeFileName', "Code/_PATCH_GBO_weapons.lua",
		}),
		PlaceObj('ModItemCode', {
			'name', "PATCH_old_ammo",
	...
	PlaceObj('ModItemFolder', {
		...
		PlaceObj('ModItemOptionChoice', {
			'name', "ApertureCTH",
			'NameColor', RGBA(164, 0, 0, 255),
			'DisplayName', "CTH Mode",
			'Help', "---Experimental, untested ----\n\nAngular Chance to Hit (aCTH) is a simulated way to determine shot hits, inspired by New Chance to Hit (NCTH) from 1.13. \n\nInstead of an attack roll, you will have a halo showing where your shots can go. The actual shot will be randomly simulated inside that ring, and a colision test will be made to check for hits and damage. You can hit other body parts in this way.\n\naCTH Lite uses the same ring, but instead of simulating the attack, it will roll a chance.\n\nOld CTH is the original behavior.",
		...
		PlaceObj('ModItemOptionToggle', {
			'name', "MuteIMPVoice",
			'DisplayName', "Silent protagonist",
			'Help', "Mutes IMP voicelines. I don't enjoy them.",
		}),
		PlaceObj('ModItemOptionChoice', {
			'name', "NightSight",
	...
	PlaceObj('ModItemFolder', {
		...
		PlaceObj('ModItemWeaponComponent', {
			...
			Cost = 30,
			DisplayName = T(520876141203, --[[ModItemWeaponComponent _ReflexSIghtVigilance DisplayName]] '"Vigilante" Reflex Sight 1x'),
			GBO_ComponentTraits = "Scope.ReflexVigilance",
		...
		PlaceObj('ModItemWeaponComponent', {
			...
			Cost = 20,
			DisplayName = T(405425855364, --[[ModItemWeaponComponent ReflexSightAdvanced_Glock DisplayName]] '"Assalto" Reflex Sight 1x'),
			GBO_ComponentTraits = "Scope.ReflexAdvanced",
			GBO_OverrideParams = {
				PlaceObj('PresetParamNumber', {
					'Name', "OverwatchAngle",
					'Value', 115,
		...
		PlaceObj('ModItemWeaponComponent', {
			...
			Cost = 30,
			DisplayName = T(363249614619, --[[ModItemWeaponComponent ReflexSightAdvanced DisplayName]] '"Assalto" Reflex Sight 1x'),
			GBO_ComponentTraits = "Scope.ReflexAdvanced",
			GBO_OverrideParams = {
				PlaceObj('PresetParamNumber', {
					'Name', "OverwatchAngle",
		...
		PlaceObj('ModItemWeaponComponent', {
			...
			Cost = 20,
			DisplayName = T(153355931022, --[[ModItemWeaponComponent ReflexSight DisplayName]] "Compact Reflex Sight 1x"),
			GBO_ComponentTraits = "Scope.Reflex",
			GBO_OverrideModes = {
				PlaceObj('GBO_ComponentModeOverride', {
					'Mode', "oldCTH",
					'Effects', {
		...
		PlaceObj('ModItemWeaponComponent', {
			...
			GBO_ComponentTraits = "Scope._2xQuick",
		...
		PlaceObj('ModItemWeaponComponent', {
			...
			GBO_ComponentTraits = "Scope._2xWide",
	...
	PlaceObj('ModItemWeaponComponent', {
		...
		GBO_ComponentTraits = "Scope.Ironsight",
		GBO_OverrideModes = {
			PlaceObj('GBO_ComponentModeOverride', {
				'Mode', "oldCTH",
				'Params', {
